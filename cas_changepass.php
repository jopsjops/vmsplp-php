...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Fetch current password for CAS dean
...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="img/cas.png">
    <title>Admin</title>
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <title>Change Password - CAS Dean</title>
</head>
...
<body>
    ...
    <div class="container">
        <div class="topbar">
            ...
            <div class="user">
                <img src="img/cas.png" alt="Profile Image" id="profileImage">
    ...
    <h2>Change Password - CAS Dean</h2>
    <div class="form-container">
        <form action="cas_changepass.php" method="POST">
