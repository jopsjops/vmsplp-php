...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="img/new_cihm.png">
    <title>VMS. (CIHM)</title>
    ...
    <style>
        * {
        ...
        .sidebar ul li a::before {
            ...
            width: 5px;
            height: 40px;
            background-color: rgba(99, 8, 0, 1);
            border-radius: 5px;
            opacity: 0;
            transform: scaleY(0);
...
<body>
    ...
    // Save the PDF
    doc.save("Student_Violation_Records(CIHM).pdf");
}
