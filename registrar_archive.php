...
<body>
    <div class="container">
        <div class="topbar">
            ...
            <div class="user">
                ...
                <div class="dropdown-content" id="dropdownContent">
                    <a href="registrar_changepass.php" id="changePasswordButton"><i class='bx bx-lock'></i> Change
                        Password</a>
        ...
        <div class="sidebar">
            <ul>
                <li class="stud">
                    <a href="registrar_dean.php">
                        <i class='bx bxs-group'></i>
                        <div>Student</div>
                    </a>
                </li>
                <li class="archive">
                    <a href="registrar_archive.php">
...
$dbname = "z6vet51amyrj9ci0"; // Your DB name
                    ...
                    $sql = "SELECT * FROM archive_info WHERE Department = 'REGISTRAR'";
