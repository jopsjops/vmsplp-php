...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="img/new_cba.png">
    <title>VMS. (CBA)</title>
    ...
    <style>
        * {
        ...
        .sidebar ul li a::before {
            ...
            width: 5px;
            height: 40px;
            background-color: rgba(166, 154, 25, 1);
            border-radius: 5px;
            opacity: 0;
            transform: scaleY(0);
...
<body>
        ...
        <div class="sidebar">
            <div class="profile">
                <div class="profile-logo">
                    <img src="img/new_cba.png" alt="Logo">
                </div>
            ...
            <div class="main-content">
                <div class="table-container">
                    ...
                    $sql = "SELECT id, Student_ID, Student_Name, Department, Program, Violation, Offense, Status, Personnel, Accomplished, Sanction, Proof
                             FROM archive_info WHERE Department = 'CBA' ORDER BY Accomplished DESC";
    ...
    // Save the PDF
    doc.save("Student_Violation_Records(CBA).pdf");
}
