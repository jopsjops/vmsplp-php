...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="img/new_coe.png">
    <title>VMS. (COE)</title>
        ...
        <div class="sidebar">
            <div class="profile">
                <div class="profile-logo">
                    <img src="img/new_coe.png" alt="Logo">
                </div>
            ...
            <div class="main-content">
                <div class="table-container">
                    ...
                    $sql = "SELECT id, Student_ID, Student_Name, Department, Program, Violation, Offense, Status, Personnel, Accomplished, Sanction, Proof
                             FROM archive_info WHERE Department = 'COE' ORDER BY Accomplished DESC";
