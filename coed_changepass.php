...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Fetch current password for COED dean
...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="img/coed.png">
    <title>Admin</title>
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <title>Change Password - COED Dean</title>
</head>
...
<body>
    ...
    <div class="container">
        <div class="topbar">
            ...
            <div class="user">
                <img src="img/coed.png" alt="Profile Image" id="profileImage">
                <div class="dropdown-content" id="dropdownContent">
                    <a href="coed_changepass.php" id="changePasswordButton"><i class='bx bx-lock'></i> Change
                        Password</a>
        ...
        <div class="sidebar">
            <ul>
                <li class="stud">
                    <a href="coed_dean.php">
                        <i class='bx bxs-group'></i>
                        <div>Student</div>
                    </a>
                </li>
                <li class="archive">
                    <a href="archive_coed.php">
    ...
    <h2>Change Password - COED Dean</h2>
    <div class="form-container">
        <form action="coed_changepass.php" method="POST">
