...
<form action="update_cba.php" method="post">
...
<script>
    document.getElementById('Department').addEventListener('change', function () {
        const course = document.getElementById('Program');
        ...
        } else if (selectedDepartment === 'CBA') {
        ...
        } else if (selectedDepartment === 'CON') {
        ...
        } else if (selectedDepartment === 'COE') {
        ...
        } else if (selectedDepartment === 'COED') {
        ...
        } else if (selectedDepartment === 'CIHM') {
