...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="img/new_cas.png">
    <title>VMS. (CAS)</title>
...
<body>
        ...
        <div class="sidebar">
            <div class="profile">
                <div class="profile-logo">
                    <img src="img/new_cas.png" alt="Logo">
                </div>
            ...
            <div class="main-content">
                <div class="table-container">
                    ...
                    $sql = "SELECT id, Student_ID, Student_Name, Department, Program, Violation, Offense, Status, Personnel, Accomplished, Sanction, Proof
                             FROM archive_info WHERE Department = 'CAS' ORDER BY Accomplished DESC";
    ...
    // Save the PDF
    doc.save("Student_Violation_Records(CAS).pdf");
}
