...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="img/cn.png">
    <title>Admin</title>
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <title>Change Password - CON Dean</title>
</head>
...
<body>
    ...
    <div class="container">
        <div class="topbar">
            ...
            <div class="user">
                <img src="img/cn.png" alt="Profile Image" id="profileImage">
                <div class="dropdown-content" id="dropdownContent">
                    <a href="con_changepass.php" id="changePasswordButton"><i class='bx bx-lock'></i> Change
                        Password</a>
    ...
    <h2>Change Password - CON Dean</h2>
    <div class="form-container">
        <form action="con_changepass.php" method="POST">
