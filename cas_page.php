...
$dbname = "z6vet51amyrj9ci0"; // Your DB name
                    ...
                    $sql = "SELECT * FROM student_info WHERE Department = 'CAS'";
                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    switch ($row['Status']) {
                                        case 'Warning':
                                            $statusColor = 'background-color: #FCEFB4;';
                                            break;
                                        case '1st Offense':
                                            $statusColor = 'background-color: #FFB480;';
                                            break;
                                        case '2nd Offense':
                                            $statusColor = 'background-color: #FF6961;';
                                            break;
                                        case '3rd Offense':
                                            $statusColor = 'background-color: #CECECD;';
                                            break;
                                        default:
                                            $statusColor = 'background-color: gray;';
                                            break;
                                    }
    ...
    <div id="modalContent">
        ...
        <form id="addForm" action="add_cas.php" method="post">
