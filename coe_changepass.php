...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Fetch current password for COE dean
...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="img/coe.png">
    <title>Admin</title>
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <title>Change Password - COE Dean</title>
</head>
...
<body>
    ...
    <div class="container">
        <div class="topbar">
            ...
            <div class="user">
                <img src="img/coe.png" alt="Profile Image" id="profileImage">
                <div class="dropdown-content" id="dropdownContent">
                    <a href="coe_changepass.php" id="changePasswordButton"><i class='bx bx-lock'></i> Change
                        Password</a>
    ...
    <h2>Change Password - COE Dean</h2>
    <div class="form-container">
        <form action="coe_changepass.php" method="POST">
