...
>>>>>>> 7a216187e36316117ac410f993c34a313d7af07e
        </div>
    </div>
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="prediction.php"><i class='fas fa-chart-line'></i>Predictions</a></li>
                    ...
                    <div class="violation-box">
                        ...
                        <ul>
                            ...
                            <li><strong>Second Offense:</strong>
                                <ul>
                                    <li><strong> Dismissal: </strong> Dropped from enrollment with credentials released</li>
                                    <li><strong> Expulsion: </strong> Banned from enrolling in any public/private school</li>
                                </ul>
                            </li>
                        </ul>
