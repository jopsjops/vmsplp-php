...
$dbname = "z6vet51amyrj9ci0"; // Your DB name
                    ...
                    $sql = "SELECT * FROM student_info WHERE Department = 'CON'";
                    ...
                    <table id="violationTable">
                        <thead>
                            <tr>
                                ...
                                <th>Program</th>
                                <th>Violation</th>
                                <th>Offense</th> <!-- Added Offense column -->
                                <th>Status</th>
                                <th>Date</th>
                                <th>Actions</th>
                            </tr>
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<tr>
                                        ...
                                        <td class='{$offenseClass}'>" . htmlspecialchars($row['Offense']) . "</td> <!-- Display Offense data -->
    ...
    <div id="modalContent">
        ...
        <form id="addForm" action="add_con.php" method="post">
