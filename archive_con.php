...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="img/con.png">
    <title>Admin</title>
...
<body>
    <div class="container">
        <div class="topbar">
            ...
            <div class="user">
                <img src="img/con.png" alt="Profile Image" id="profileImage">
...
$dbname = "z6vet51amyrj9ci0"; // Your DB name
                    ...
                    $sql = "SELECT * FROM archive_info WHERE Department = 'CON'";
