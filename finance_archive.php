        ...
        <div class="topbar">
            ...
            <div class="user">
                ...
                <div class="dropdown-content" id="dropdownContent">
                    <a href="finance_changepass.php" id="changePasswordButton"><i class='bx bx-lock'></i> Change
                        Password</a>
...
$dbname = "z6vet51amyrj9ci0"; // Your DB name
                    ...
                    $sql = "SELECT * FROM archive_info WHERE Department = 'FINANCE'";
